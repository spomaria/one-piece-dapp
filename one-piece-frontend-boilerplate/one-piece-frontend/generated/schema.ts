...
export class CharacterTraitDetermined extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save CharacterTraitDetermined entity without an ID",
    );
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type CharacterTraitDetermined must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("CharacterTraitDetermined", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): CharacterTraitDetermined | null {
    return changetype<CharacterTraitDetermined | null>(
      store.get_in_block("CharacterTraitDetermined", id.toHexString()),
    );
  }

  static load(id: Bytes): CharacterTraitDetermined | null {
    return changetype<CharacterTraitDetermined | null>(
      store.get("CharacterTraitDetermined", id.toHexString()),
    );
  }
...
export class NftRequested extends Entity {
  ...
  static loadInBlock(id: Bytes): NftRequested | null {
    return changetype<NftRequested | null>(
      store.get_in_block("NftRequested", id.toHexString()),
    );
  }
