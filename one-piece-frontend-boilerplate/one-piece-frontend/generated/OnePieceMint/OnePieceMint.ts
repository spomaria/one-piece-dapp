...
export class CharacterTraitDetermined extends ethereum.Event {
  get params(): CharacterTraitDetermined__Params {
    return new CharacterTraitDetermined__Params(this);
  }
}

export class CharacterTraitDetermined__Params {
  _event: CharacterTraitDetermined;

  constructor(event: CharacterTraitDetermined) {
    this._event = event;
  }
...
export class OnePieceMint extends ethereum.SmartContract {
  static bind(address: Address): OnePieceMint {
    return new OnePieceMint("OnePieceMint", address);
  }
  ...
  s_addressToCharacter(param0: Address): BigInt {
    let result = super.call(
      "s_addressToCharacter",
      "s_addressToCharacter(address):(uint256)",
      [ethereum.Value.fromAddress(param0)],
    );
  ...
  try_s_addressToCharacter(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "s_addressToCharacter",
      "s_addressToCharacter(address):(uint256)",
      [ethereum.Value.fromAddress(param0)],
...
export class RequestNFTCall extends ethereum.Call {
  get inputs(): RequestNFTCall__Inputs {
    return new RequestNFTCall__Inputs(this);
  }

  get outputs(): RequestNFTCall__Outputs {
    return new RequestNFTCall__Outputs(this);
  }
}

export class RequestNFTCall__Inputs {
  _call: RequestNFTCall;

  constructor(call: RequestNFTCall) {
    this._call = call;
  }
...
export class RequestNFTCall__Outputs {
  _call: RequestNFTCall;
