...
export function createCharacterTraitDeterminedEvent(
  characterId: BigInt
): CharacterTraitDetermined {
  let characterTraitDeterminedEvent = changetype<CharacterTraitDetermined>(
    newMockEvent()
  )

  characterTraitDeterminedEvent.parameters = new Array()

  characterTraitDeterminedEvent.parameters.push(
    new ethereum.EventParam(
      "characterId",
