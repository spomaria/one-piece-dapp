...
contract OnePieceMint is VRFConsumerBaseV2, ERC721, Ownable, ERC721URIStorage {
    ...
    // the function to request NFT minting
    ...
    // adding randomness to the contract
    ...
    // function that determines user character based on answers provided
